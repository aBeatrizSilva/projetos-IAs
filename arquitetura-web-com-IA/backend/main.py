...
# Deixamos ativas apenas as figurinhas cujas imagens existem na pasta figurinhas/ (ids 1 a 29)
# A figurinha 30 está comentada pois sua imagem não existe na pasta
figurinhas = [
...
# Endpoint GET "/figuras" (e "/figurinhas" para compatibilidade com o frontend existente)
@app.get("/figuras")
@app.get("/figurinhas")
...
def obter_imagem(id: int):
    # Procura pelo arquivo com prefixo formatado (ex: 01) e que não seja seguido de outros dígitos
